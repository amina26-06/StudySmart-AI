...
# AI STUDY MENTOR PAGE
    ...
    st.write("Ask questions and get personalized AI-powered learning guidance.")
        ...
        if question.strip():
            ...
            try:
                ...
                if not api_key:
                    ...
                    prompt = f"""
You are StudySmart AI, a friendly and helpful AI Study Mentor.
...
Give clear, simple, student-friendly answers.
...
"""
                    ...
                    with st.spinner("🤖 StudySmart AI is thinking..."):
                    ...
                    st.subheader("🤖 AI Study Mentor Response")
